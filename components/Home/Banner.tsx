...
const Banner = () => {
    return (
        <div className='min-h-[80vh]'>
            <div className="absolute overflow-hidden w-full min-h-[20rem] md:min-h-[700px] mb-[20rem] md:mb-0">
                <Image
                    src={home_banner}
                    alt="banner"
                    layout="fill"
                    ...
                    objectFit="cover"
                    className='w-full max-h-[20rem] md:max-h-[100vh] overflow-hidden'
            ...
            <div className="pt-[24rem] md:pt-[14rem] container mx-auto md:px-20 h-full ">
                <div className="transform px-5">
                    <h1 className="text-5xl md:text-6xl font-bold">Ready To Adopt!</h1>
                    <p className=" relative max-w-[60ch] text-gray-400 z-1 md:text-gray-500 py-4 text-xl">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.
                    </p>
                    <Button size='lg'>
                        <div className="text-lg font-bold">Start now</div>
                    </Button>
                </div>
            </div>
        </div>
