...
const Banner = () => {
    return (
        <div className="relative overflow-hidden w-full min-h-[700px]">
            ...
            <div className="container mx-auto md:px-20 h-full">
                <div className="absolute top-1/2 transform -translate-y-1/2">
                    <h1 className="text-3xl md:text-6xl font-bold">Ready To Adopt!</h1>
                    <p className="max-w-[60ch] text-gray-400 py-4 text-xl">
